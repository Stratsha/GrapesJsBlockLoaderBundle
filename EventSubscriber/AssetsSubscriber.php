...
namespace MauticPlugin\GrapesJsBlockLoaderBundle\EventSubscriber;

use Mautic\CoreBundle\CoreEvents;
use Mautic\CoreBundle\Event\CustomAssetsEvent;
use Mautic\InstallBundle\Install\InstallService;
use MauticPlugin\GrapesJsBlockLoaderBundle\Integration\Config;
...
class AssetsSubscriber implements EventSubscriberInterface
{
    ...
    public function injectAssets(CustomAssetsEvent $assetsEvent): void
    {
        ...
        if ($this->config->isPublished()) {
            $assetsEvent->addScript('plugins/GrapesJsBlockLoaderBundle/Assets/dist/index.js');
        }
    }
